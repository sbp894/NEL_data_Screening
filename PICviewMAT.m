...
FIG.handles.PrevPicPB=uicontrol('Parent',FIG.num,'Style','pushbutton','enable', 'off', ...
...
FIG.handles.badLinesRemoveAccept=uicontrol('Parent',FIG.num,'Style','pushbutton',...
    'String','Accept','Units','normalized','Position',[0.8 0.3 0.1 0.05],...
    'Visible','on', 'Backgroundcolor', [.7 .7 .7], 'callback', 'screenDataMAT(''badLinesRemoveAccept'')');
