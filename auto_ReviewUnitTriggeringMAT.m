function FIG=auto_ReviewUnitTriggeringMAT(FIG)
% FIG=auto_ReviewUnitTriggeringMAT(FIG)
% Created: SP (Aug 2017)
% Called from auto_screenDataMAT
...
if checkRASTER
    if ~strcmp('tc',getTAG(getFileName_inDir(FIG)))
        ...
        FIG=auto_PICviewMAT(FIG, FIG.PICnum, FIG.num);
        ...
        guidata(FIG.num, FIG);
        auto_screenDataMAT('NextPic_PBcallback');
        FIG=guidata(FIG.num);
    end
end
